...
class FromJsonTest extends QueryTest with SharedSparkSession {
  ...
  private[this] val SCHEMA = """{"type":"record","name":"schema","fields":[{"name":"a_double","type":["double"]},{"name":"b_int","type":["int"]},{"name":"c_bool","type":["boolean"]},{"name":"d_string","type":["null","string"],"default":null},{"name":"e_long","type":["null","long"],"default":null}]}"""
  
  /**
   * 运行后异常提示转换出错
   */
  test("from_json_with_FAILFAST") {
    val df1 = SEQ1.toDF("value")
